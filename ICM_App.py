...
st.set_page_config(page_title='Industrial copper',page_icon=icon,initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Yashvanth. P'})


#set up the sidebar with optionmenu
with st.sidebar:
    selected = option_menu("MainMenu",
                            options=["Get Prediction","About"],
    ...
    if select == 'Selling Price':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('E:/Education/Project/IndustrialCopperModeling/price_prediction.pkl','rb') as files:
                    predict_model=joblib.load(files)
    ...
    if select == 'Status':
        ...
        if button:
            ...
            if not all([item_date, delivery_date, country, item_type, application, product_ref,
                ...
                with open('E:/Education/Project/IndustrialCopperModeling/Status_Prediction.pkl','rb') as files:
